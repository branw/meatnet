...
func (pt ProductType) String() string {
	...
	case ProductTypeUnknown:
		return "unknown"
	case ProductTypePredictiveProbe:
		return "predictive-probe"
	case ProductTypeRepeaterNode:
...
type ManufacturerData struct {
	...
	//TODO The following fields aren't present on devices with older firmware.
	// We should check the length of the manufacturer data before reading after
	// byte 18 if we want to support them.
